    ...
    <div class="row justify-content-center">
        <div class="col-md-8 auth-page-frgt">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('password.reset') }}" class="auth-frgt-form">
                        @csrf
                        ...
                        <div class="form-group row " style="display:none">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') ?? get_user_by_token($token) }}" required autocomplete="email" autofocus>
