							...
							<td  colspan="2" style="padding: 20px 0;background: #fff;border-bottom: 2px solid #969696;">
								<table width="100%;">
									<tr>
										<td width="30"></td>
										<td width="480">											
											<img  align="left" style="width:200px;" src="logo.svg">
										</td>
										<td width="30"></td>
									</tr>
								</table>
							...
							<td style="padding: 30px 0;background-color: #fff;">
								<table width="100%;" bgcolor="#fff">
									<tr>
										<td width="30"></td>
										<td width="480">
											<p style="font-size: 16px;color: #000;">Dear Suresh Company Colleagues</p>
											<p style="font-size: 14px;color: #000;line-height: 21px;">
												It is our privilage to invite you to take part in the Inspiration of the Year Global Award 2018. Entries for the award commenced on June 25 will be open through August 31.
											</p>
											<p style="font-size: 14px;color: #000;line-height: 21px;">
												It is our privilage to invite you to take part in the Inspiration of the Year Global Award 2018. Entries for the award commenced on June 25 will be open through August 31.
											</p>
