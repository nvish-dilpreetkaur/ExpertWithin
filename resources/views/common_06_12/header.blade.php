        ...
        <div class="col-md-6">
          <div class="header-rite-icons">
            	<ul>
                  ...
                  <li id="header-profile__dropdown-view" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><a href="#" class="main-header--user-info-card__picture"><i class=''></i><p>Me</p></a></li>
                  <!-----modal-content-->
                      ...
                      <div class="container">
                        <div class="row">
                          <div class="col-md-4 for-null-paddng">
                            <div class="main-page__dropdown--user-info-card__picture">
                              <i class=''></i>
                            </div>
                          </div>
