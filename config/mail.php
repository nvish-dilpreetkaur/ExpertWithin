...
return [
    ...
    */
    ...
    'from' => [
        'address' => env('MAIL_FROM_ADDRESS', 'no-reply@klovelab.com'),
        'name' => env('MAIL_FROM_NAME', 'ExpertWithin'),
    ],
    ...
    */
	...
	//Custom mail constants
	'SEND_EMAILS'                         => env('MAIL_SEND_EMAILS'),  //true/false
	'SEND_LIVE_EMAILS'                    => env('MAIL_SEND_LIVE_EMAILS'),  //true/false
